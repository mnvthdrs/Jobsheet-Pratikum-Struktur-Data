...
void display()
{
    ...
    printf("%d ", deque[r]); // Menampilkan elemen terakhir
}

// Fungsi getfront mengambil nilai pertama dari deque.
void getfront()
{
    if ((f == -1) && (r == -1))
    {
...
// fungsi delete_front() digunakan untuk menghapus elemen dari depan
void delete_front()
{
    if ((f == -1) && (r == -1))
    {
